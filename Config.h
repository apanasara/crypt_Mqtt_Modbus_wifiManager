//https://github.com/madpilot/GarageDoorOpener/blob/f8840e556511adeaa0ce1b4ea5e87cd9130d00ff/Config.h
...
class Config {
  public:
    ...
    void set_mqttCAcert(const char* val);
  ...
  private:
    ...
    char* mqttCAcert ;//= (char*)malloc(1535);
